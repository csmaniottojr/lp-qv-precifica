...
const Hero = () => (
    <section className="relative bg-white overflow-hidden">
        <div className="custom-screen py-20 relative z-10">
            ...
            >
                <div>
                    <div className="space-y-6 max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-5xl text-gray-900 font-extrabold mx-auto leading-tight sm:text-6xl lg:text-7xl">
                            Aumente seu lucro com precificação baseada em{' '}
                            <span className="text-primary-800">dados reais</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center items-center font-medium text-base gap-4 pt-4">
                            <NavLink
                                href="/#pricing"
                                className="flex items-center justify-center w-full sm:w-auto text-white bg-primary-800 hover:bg-primary-700 active:bg-primary-900 px-8 py-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5"
                            >
                                Começar Agora
                            ...
                            <NavLink
                                href="/#contact"
                                className="flex items-center justify-center w-full sm:w-auto text-primary-800 bg-white border-2 border-primary-800 hover:bg-primary-50 active:bg-primary-100 px-8 py-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
                            >
                                Falar com Vendas
                            </NavLink>
                        </div>
